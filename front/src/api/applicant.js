...
export function applicantGetBalance() {
  return apiClient.get('/api/applicant/balance/')
}

// Получить список курсов
export function applicantGetCourses() {
  return apiClient.get('/api/applicant/courses/')
}

// Получить публичные курсы (без авторизации)
export function applicantGetPublicCourses() {
  return apiClient.get('/api/applicant/courses/public/')
}

// Получить историю платежей
export function applicantGetPayments() {
  return apiClient.get('/api/applicant/payments/')
}

// Создать платеж
export function applicantCreatePayment(payload) {
  return apiClient.post('/api/applicant/payments/create/', payload)
}
